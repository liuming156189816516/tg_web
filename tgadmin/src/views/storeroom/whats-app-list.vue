    ...
    <div style="width:100%;height: 100%; float: left; position: relative;">
        ...
        <div class="continer_main">
            ...
            <div class="group_continer" style="margin-left: 20px;">
                ...
                <el-table @sort-change="sorthandle" :data="accountDataList" row-key="id" use-virtual border height="700" v-loading="loading"
                    ...
                    <el-table-column prop="use_status" :label="$t('sys_g023')" minWidth="100">
                        <template slot="header">
                    ...
                    <el-table-column prop="staff_no" :label="$t('sys_mat063')" minWidth="100">
                        <template slot="header">
